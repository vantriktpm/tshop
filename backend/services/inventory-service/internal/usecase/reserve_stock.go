...
type ReserveStock struct{ repo domain.InventoryRepository }

func NewReserveStock(repo domain.InventoryRepository) *ReserveStock { return &ReserveStock{repo: repo} }
